    ...
    return(
        ...
        <div className="container p-3 bg-dark">
                    ...
                    <p className="xSmall col-3">
                        ...
                        <br/>
                        <span className="xxsmall">Back End Lead, Front End Dev and Production Leader.</span>
                        <br/> <br/>
                        ...
                        <br/>
                        <b>Nationality</b>: Filthy Conservative American.</p>
                    <img
                    ...
                    <p className="xSmall col-3">
                        ...
                        <br/>
                        <span className="xxsmall">Front End Lead, Writer Lead and Production Dev.</span>
                        <br/> <br/>
                        ...
                        <br/>
                        <b>Nationality</b>: Libtard NZ European.</p>
                    <img 
                    ...
                    <br/>
                    &nbsp;Operating clandestine and worldwide, the Foundation operates beyond jurisdiction, empowered and entrusted by every major national government with the task of containing anomalous objects, entities, and phenomena. Many of these anomalies pose a significant threat to global security by threatening either physical or psychological harm. All of them undermine the natural laws that the people of the world implicitly trust in.<br/><br/>&nbsp;The Foundation maintains an extensive database of information regarding anomalies requiring Special Containment Procedures, commonly referred to as "SCPs". The primary database contains summaries of such anomalies and emergency procedures for maintaining or re-establishing safe containment in the case of a containment breach or other event.<br/><br/>&nbsp;The Foundation operates to maintain normalcy, so that the worldwide civilian population can live and go on with their daily lives without fear, mistrust, or doubt in their personal beliefs, and to maintain human independence from extraterrestrial, extradimensional, and other extranormal influence.<br/><br/><span className="med">Our mission is three-fold:</span><br/>
                    <span className="med">Secure</span><br/>
                    &nbsp;The Foundation secures anomalies with the goal of preventing them from falling into the hands of civilian or rival agencies, through extensive observation and surveillance and by acting to intercept such anomalies at the earliest opportunity.<br/><br/>
                    <span className="med">Contain</span><br/>
                    &nbsp;The Foundation contains anomalies with the goal of preventing their influence or effects from spreading, by either relocating, concealing, or dismantling such anomalies or by suppressing or preventing public dissemination of knowledge thereof.<br/><br/>
                    <span className="med">Protect</span><br/>
                    ...
                    <br/><br/>
                    Additional information will have been provided upon your joining us in pursuit of our primary missions. Welcome to the Foundation, and good luck.
