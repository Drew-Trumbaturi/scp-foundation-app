      ...
      <div className="container">
        <div className="bg-dark container">
          ...
          <p className="container">
            ...
            never fully told of. We can imagine you already have a few
            questions, whether it be where you are, who is here with you, or why
            you were chosen to be here. Many of these questions we will not be
            able to answer. Some of those, we will.
            <br />
            ...
            may also be read. , how our classification system works. Violation
            of clearance levels is grounds for instant contract termination, and
            ...
            . Due to the vast amount of anomalous items in our possession, we
            have multiple operational departments, each focusing on a different
            aspect of our research. Cursory knowledge of these sectors may
            assist you when handling unknown objects.
            <br />
            <br />
            <strong>
              &middot;&emsp;
            ...
            , our highly specialized containment teams. Depending on the
            anomaly, you may require a different kind of expertise than what you
            personally know, so a cursory knowledge of this list may help during
            times of crisis. A more
            ...
            lower security clearances, so do not be alarmed if you cannot see
            any names.
            <br />
            <br />
            <strong>
            ...
            , a list of other organisations aware of the anomalous. A list of
            more
            ...
            , a list of objects contained by the Foundation which do not
            currently warrant an SCP designation and containment procedures. A
            number of these items are available for testing purposes upon
            request.
            <br />
            <br />
            <strong>
